...
const parentsArray = ["Valentyna", "Yuriy"];

// 3. Combine these two arrays.
const superPeopleArray = parentsArray.concat(favCharactersArray);
console.log(superPeopleArray); // ['Valentyna', 'Yuriy', 'Daenerys', 'Aria', 'Thyrion', 'Varys', 'Brandon']

// 4. Add your pets' names.
superPeopleArray.push("Kuz");
console.log(superPeopleArray); // ['Valentyna', 'Yuriy', 'Daenerys', 'Aria', 'Thyrion', 'Varys', 'Brandon', 'Kuz]

// 5. Reverse the order of the array.
superPeopleArray.reverse();
console.log(superPeopleArray); // ['Kuz', 'Brandon', 'Varys', 'Thyrion', 'Aria', 'Daenerys', 'Yuriy', 'Valentyna']

// 6. Access one of your parents' names.
console.log(superPeopleArray[superPeopleArray.length - 2]); // Yuriy

// 7. Update the name of one of your parents. 
superPeopleArray[superPeopleArray.length - 2] = "Iurii";
console.log(superPeopleArray); // ['Kuz', 'Brandon', 'Varys', 'Thyrion', 'Aria', 'Daenerys', 'Iurii', 'Valentyna']